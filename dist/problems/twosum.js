...
function parseInputToStdin(rawInput) {
...
const TestCases = [
    ...
    {
        'input': 'nums = [33, -37, 61, 59, -14, -26, 49, 4, -21, -31, 88], target = -63',
        'output': '[1, 5]',
        'explanation': 'nums[5] + nums[1] == -26 + -37 == -63'
    },
    {
        'input': 'nums = [33, 65, -38, 35, 99, 55, 26, -3, 1, -4, 0, 50, 86, 28], target = 125',
        'output': '[4, 6]',
    ...
    {
        'input': 'nums = [-40, 1, -21, 22, -28, -4, -16, 11, 38, -33, -39, 12, 67, 68, 30], target = -9',
        'output': '[10, 14]',
    ...
    {
        'input': 'nums = [50, -28, -48, -31, -38, 60, 3, 81, -32, -50, 61, 98, 72, 16, -11, 63, -6], target = 19',
        'output': '[0, 3]',
        'explanation': 'nums[0] + nums[3] == 50 + -31 == 19'
    },
    {
        'input': 'nums = [-10, 94, -1, -40, 81, 43, 2, -41, 15, 19, 22, 14, 70, 37, 9, -44, 18], target = 107',
        'output': '[12, 13]',
        'explanation': 'nums[13] + nums[12] == 37 + 70 == 107'
    },
    {
        'input': 'nums = [25, 6, 33, 75, 83, -13, 52, 98, 1, 47, -38, -7, 88, 29, 35, 85, -8, -29], target = 76',
        'output': '[3, 8]',
    ...
    {
        'input': 'nums = [-44, 45, 0, -13, -29, 17, -16, -45, 73, 52, 29, 63], target = 60',
        'output': '[3, 8]',
        'explanation': 'nums[3] + nums[8] == -13 + 73 == 60'
    },
    {
        'input': 'nums = [34, 88, 38, 92, -19, 80, 50, 44, 60, -37, 72, 7, 63, 77, 43, 75, 93, 45], target = 155',
        'output': '[5, 15]',
        'explanation': 'nums[5] + nums[15] == 80 + 75 == 155'
    },
    {
        'input': 'nums = [59, 86, -38, 58, -28, 92, 80, 78, 27, 7, 81, 5, 36, 66, 30, -16, -15, 65], target = 8',
        'output': '[4, 12]',
        'explanation': 'nums[4] + nums[12] == -28 + 36 == 8'
    },
    {
        'input': 'nums = [88, 21, 46, 60, -9, -28, -25, 14, -49, 26, 36, 64, 17], target = 82',
        'output': '[2, 10]',
    ...
    {
        'input': 'nums = [95, 61, 27, 76, -14, 24, -6, 87, -47, -42, 58, 82, 91, 19, 6, 75, 4, 70, 69], target = -28',
        'output': '[8, 13]',
        'explanation': 'nums[8] + nums[13] == -47 + 19 == -28'
    },
    {
        'input': 'nums = [-32, -16, 20, 72, 48, 69, -10, 73, 3, -15, -42, 21, 38, 18, -12, 35], target = -22',
        'output': '[2, 10]',
        'explanation': 'nums[2] + nums[10] == 20 + -42 == -22'
    },
    {
        'input': 'nums = [38, -44, -4, 8, 2, -16, -34, 85, -11, 7, -32, 23, 43, 72, -21, 17], target = -55',
        'output': '[6, 14]',
    ...
    {
        'input': 'nums = [-1, -37, -42, 69, 3, 95, 12, 13, 58, 88, 86, 8, 17, -25, 23, 59, -49, 21, -36, -10], target = 81',
        'output': '[3, 6]',
    ...
    {
        'input': 'nums = [88, -11, 37, 36, 43, 60, 67, -20, 16, 6, -48, 45, -21, -49, 52, 18, -40, -2, 58], target = 133',
        'output': '[0, 11]',
        'explanation': 'nums[11] + nums[0] == 45 + 88 == 133'
    },
    {
        'input': 'nums = [65, 22, 51, -26, -42, 35, 59, 73, 78, -19, 5, -33], target = -68',
        'output': '[3, 4]',
        'explanation': 'nums[3] + nums[4] == -26 + -42 == -68'
    },
    {
        'input': 'nums = [-24, 87, 65, -33, -44, 2, 1, 13, 21, -18, -38, 19, 71, 90], target = 66',
        'output': '[2, 6]',
        'explanation': 'nums[6] + nums[2] == 1 + 65 == 66'
    },
    {
        'input': 'nums = [22, -50, 80, 15, -3, 41, 85, -8, 56, -16, 0, 28, -37, -5, 38], target = 4',
        'output': '[5, 12]',
        'explanation': 'nums[5] + nums[12] == 41 + -37 == 4'
    },
    {
        'input': 'nums = [15, -48, -40, -49, 17, 81, 47, 57, 48, 53, 86, 82, -12, 95, 9, 89, 83, -33], target = 68',
        'output': '[0, 9]',
    ...
    {
        'input': 'nums = [89, 49, -6, 53, -23, 60, -27, 55, 32, 10, 50, 74, -28, 16], target = -34',
        'output': '[2, 12]',
    ...
    {
        'input': 'nums = [-14, -9, -6, -24, 0, 31, -25, 69, -1, 10, 19, 46, -13], target = -15',
        'output': '[0, 8]',
        'explanation': 'nums[0] + nums[8] == -14 + -1 == -15'
    },
    {
        'input': 'nums = [-17, -46, 75, 60, -6, -45, 5, 67, 98, 93, -25, -36, -9, -4, -8, -41, -33, 97, -27], target = 68',
        'output': '[9, 10]',
    ...
    {
        'input': 'nums = [26, -3, 44, 81, 38, -31, 46, 9, 51, 19, -49, 2, 77, -19, -10, 65, 70, -5, 49], target = 121',
        'output': '[8, 16]',
        'explanation': 'nums[16] + nums[8] == 70 + 51 == 121'
    },
    {
        'input': 'nums = [45, -8, -26, -47, 21, -18, 64, 68, -43, 63, -5, 8], target = 16',
        'output': '[4, 10]',
        'explanation': 'nums[10] + nums[4] == -5 + 21 == 16'
    },
    {
        'input': 'nums = [-10, 43, 39, 34, -15, -33, -2, -46, 84, 95, -22, 73, -24], target = 179',
        'output': '[8, 9]',
    ...
    {
        'input': 'nums = [54, -16, -29, -20, -23, -35, 30, 27, 67, -17, 20, -27, 55, 60, -6, -22], target = 4',
        'output': '[4, 7]',
    ...
    {
        'input': 'nums = [95, 18, 90, 97, 29, 60, -45, 88, 31, 8, -7, 45, 38, 61, 73], target = 49',
        'output': '[1, 8]',
        'explanation': 'nums[1] + nums[8] == 18 + 31 == 49'
    },
    {
        'input': 'nums = [97, -7, -26, -37, 94, -42, 51, -24, -46, -45, 33, 1, 92], target = -9',
        'output': '[5, 10]',
        'explanation': 'nums[5] + nums[10] == -42 + 33 == -9'
    },
    {
        'input': 'nums = [-8, -39, 30, 64, 80, -6, 35, 31, -5, -2, 58, 89, -42, 57, -28, 13, -33, -16], target = 147',
        'output': '[10, 11]',
        'explanation': 'nums[10] + nums[11] == 58 + 89 == 147'
    },
    {
        'input': 'nums = [-38, -14, -24, 2, 29, -32, 37, 86, -19, 30, 67, -10, 72, 62, 27, 33, 80, 82, 43], target = 99',
        'output': '[6, 13]',
        'explanation': 'nums[6] + nums[13] == 37 + 62 == 99'
    },
    {
        'input': 'nums = [97, -5, 28, 64, -43, 29, 38, -6, -31, -30, 63], target = -74',
        'output': '[4, 8]',
    ...
    {
        'input': 'nums = [9, 52, 57, 96, 73, 51, 40, -6, 49, -36, 63, -39, -20, 32, 55], target = 92',
        'output': '[1, 6]',
    ...
    {
        'input': 'nums = [-27, 7, 63, 94, 97, 91, 53, -41, -26, -21, 51, 29, 36, 54, -31, -48, 87], target = 50',
        'output': '[5, 7]',
        'explanation': 'nums[5] + nums[7] == 91 + -41 == 50'
    },
    {
        'input': 'nums = [75, 79, -24, 49, 95, -28, 1, 41, 84, 0, 44, 81], target = 21',
        'output': '[3, 5]',
        'explanation': 'nums[3] + nums[5] == 49 + -28 == 21'
    },
    {
        'input': 'nums = [74, 40, -17, -15, 66, 88, 21, -36, -47, 99, 9], target = 41',
        'output': '[5, 8]',
        'explanation': 'nums[5] + nums[8] == 88 + -47 == 41'
    },
    {
        'input': 'nums = [78, 43, 63, -4, -2, 31, 56, 57, 44, 46, 59, 28, 13, 14, 36, -33, 48], target = 12',
        'output': '[4, 13]',
        'explanation': 'nums[13] + nums[4] == 14 + -2 == 12'
    },
    {
        'input': 'nums = [55, -1, 87, -18, -9, -50, 41, 62, 57, 13, -37, -29, -28, -14], target = 27',
        'output': '[0, 12]',
        'explanation': 'nums[12] + nums[0] == -28 + 55 == 27'
    },
    {
        'input': 'nums = [-40, -34, 95, 89, -6, 27, 10, 80, -8, 78, -45, 57, 97, -48, 16, -22], target = 105',
        'output': '[3, 14]',
    ...
    {
        'input': 'nums = [-1, 64, 41, 15, 60, 99, 61, 4, -39, -49, 68, -46, 42, -12, 85, 65, 6, 73], target = 125',
        'output': '[4, 15]',
        'explanation': 'nums[15] + nums[4] == 65 + 60 == 125'
    },
    {
        'input': 'nums = [59, -40, 37, -30, 99, 29, 28, 25, 60, 83, -46, -8, -36, 64, 14, -2, -33, 43], target = 147',
        'output': '[9, 13]',
        'explanation': 'nums[9] + nums[13] == 83 + 64 == 147'
    },
    {
        'input': 'nums = [-41, 29, -37, 94, 89, 63, -30, -21, 90, -31, -5, 93, -4, 20, -29, 67], target = 26',
        'output': '[0, 15]',
    ...
    {
        'input': 'nums = [48, -22, 50, 99, 69, 25, 95, 7, 36, -46, -27], target = -20',
        'output': '[7, 10]',
    ...
    {
        'input': 'nums = [-4, 26, 15, 53, 89, -31, 1, -28, 32, 62, 12, -42, 77, 66], target = -30',
        'output': '[5, 6]',
        'explanation': 'nums[5] + nums[6] == -31 + 1 == -30'
    },
    {
        'input': 'nums = [-28, -25, -2, 18, 80, 75, 61, -10, -39, -14, 4, -1, 40], target = -49',
        'output': '[7, 8]',
    ...
    {
        'input': 'nums = [-21, -10, -32, 47, -4, 82, -35, -41, 98, 93, 18, 55, -14, 4, 8, 17, -19], target = 28',
        'output': '[3, 16]',
    ...
    {
        'input': 'nums = [6, 85, -37, -48, -49, 28, 74, 45, 29, -44, 84, 68, 76, 38, 25, 42, -38, 87, -6], target = 113',
        'output': '[8, 10]',
        'explanation': 'nums[8] + nums[10] == 29 + 84 == 113'
    },
    {
        'input': 'nums = [7, 94, 24, 45, -4, -40, 0, 83, -24, 17, 49, 77, 37, 90, -33, 87, 54, 20, 25], target = 44',
        'output': '[0, 12]',
    ...
    {
        'input': 'nums = [88, 97, -21, 39, 35, 19, 18, 74, 91, 59, 90, 61, 94, -26, 66, -1, 36], target = 34',
        'output': '[4, 15]',
    ...
    {
        'input': 'nums = [18, -20, -39, -31, -5, 0, -23, -3, -22, -30, -26], target = -21',
        'output': '[0, 2]',
        'explanation': 'nums[0] + nums[2] == 18 + -39 == -21'
    },
    {
        'input': 'nums = [-15, 13, 15, 24, 81, 89, 1, -45, 84, -10, 17, -34, 64, -36, -4, 33, -18, 11, 58, -48], target = -52',
        'output': '[14, 19]',
...
function findAllTwoSumAnswers(nums, target) {
    const answers = [];
...
const processedTestCases = TestCases.map(tc => {
    const match = tc.input.match(/nums\s*=\s*\[([^\]]+)\],\s*target\s*=\s*(-?\d+)/);
    let output = tc.output;
    if (match) {
        const nums = match[1].split(",").map(n => Number(n.trim()));
        const target = Number(match[2].trim());
        const answers = findAllTwoSumAnswers(nums, target);
        if (answers.length > 1) {
